...
#Region "Control Method"
    Private Sub btnSearch_ServerClick(sender As Object, e As System.EventArgs) Handles btnSearch.ServerClick
        ...
        With dt
            .Columns.Add("_Class_")
            .Columns.Add("Customer_Site_Code")
            .Columns.Add("Customer_Site_Name")
            .AcceptChanges()
        End With
        dr = dt.NewRow
        dr("_Class_") = "listItemOdd"
        dr("Customer_Site_Code") = "10001"
        dr("Customer_Site_Name") = "สำนักงานใหญ่"
        dt.Rows.Add(dr)

        dr = dt.NewRow
        dr("_Class_") = "listItemEven"
        dr("Customer_Site_Code") = "10002"
        dr("Customer_Site_Name") = "สาขา ย่อย 1"
        dt.Rows.Add(dr)

        dr = dt.NewRow
        dr("_Class_") = "listItemOdd"
        dr("Customer_Site_Code") = "10003"
        dr("Customer_Site_Name") = "สาขา ย่อย 1 / คลังสินค้า 1"
        dt.Rows.Add(dr)
