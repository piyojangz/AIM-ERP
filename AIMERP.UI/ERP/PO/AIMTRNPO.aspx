<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master"
    CodeBehind="AIMTRNPO.aspx.vb" Inherits="AIMERP.UI.AIMTRNPO" %>
                        ...
                        <table style="width: 100%;">
                            ...
                            <tr>
                                ...
                                <td class="rightCol">
                                    <table>
                                        <tr>
                                            <td>
                                                <asp:TextBox ID="TextBox28" runat="server" CssClass="list-group-item" 
                                                    Width="150px"></asp:TextBox>
                                            </td>
                                            <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <table>
                                        <tr>
                                            <td>
                                                <asp:TextBox ID="TextBox36" runat="server" CssClass="list-group-item" 
                                                    Width="150px"></asp:TextBox>
                                            </td>
                                            <td>
                                                <button ID="btnSearch12" runat="server" class="btn btn-default" type="button">
                                                    <span class="glyphicon glyphicon-search"></span>
                                                </button>
                                            </td>
                                        </tr>
                            ...
                            <tr>
                                ...
                                <td class="1px">
                                    : </td>
                                <td class="rightCol">
                                    <asp:TextBox ID="TextBox34" runat="server" CssClass="list-group-item" 
                                        Width="150px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="leftCol">
                                    จัดส่งที่ (Ship To)</td>
                                <td class="1px">
                                    :
                                </td>
                                <td class="right">
                                    <table>
                                        <tr>
                                            <td>
                                                <asp:TextBox ID="TextBox35" runat="server" CssClass="list-group-item" 
                                                    Width="150px"></asp:TextBox>
                                            </td>
                                            <td>
                                                <button ID="btnSearch11" runat="server" class="btn btn-default" type="button">
                                                    <span class="glyphicon glyphicon-search"></span>
                                                </button>
                                            </td>
                                        </tr>
                                ...
                                <td class="1px">
                                    :</td>
                                <td class="rightCol">
                                    <asp:TextBox ID="txtField11" runat="server" CssClass="list-group-item" 
                                        Width="150px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
